...
create table `ranking` (id bigint generated by default as identity, created_at timestamp(6) not null, day integer, month integer, rank integer, type varchar(255) not null, updated_at timestamp(6) not null, week integer, year integer, product_id bigint not null, primary key (id))
